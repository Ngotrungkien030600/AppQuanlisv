package com.example.appquanlisv.adapter;
...
import com.example.appquanlisv.ActivityStudent;
import com.example.appquanlisv.R;
import com.example.appquanlisv.model.Student;

import java.util.ArrayList;

public class asapterstudent extends BaseAdapter {

    private ActivityStudent context;
    private ArrayList<Student> ArrayListStudent;

    public asapterstudent(ActivityStudent context, ArrayList<Student> arrayListStudent) {
